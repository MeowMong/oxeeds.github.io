...
<body>
    ...
    <header>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-4 bg-white text-black text-start" id="img-header-TWH"><img src="img/index/TWH.png" width="100px" class="img-fluid" /></div>
                <div class="col-sm-4 bg-white text-black text-center" id="txt-header">SDN 1 PURWOKERTO KULON</div>
                <div class="col-sm-4 bg-white text-black text-end" id="img-header-BC"><img src="img/index/BanyumasColor.png" width="100px" class="img-fluid" /></div>
            </div>
        </div>
    </header>
    <!-- Akhir dari Header -->
    ...
    <nav class="navbar navbar-expand-lg text-white bs5" style="background-color: #282a35">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav" id="bg-nav">
                ...
                <a id="button-nav" class="nav-link active text-white" style="background-color: #00a859" aria-current="page" href="#">Galeri</a>
    ...
    <section id="gallery" class="vh-80 d-flex justify-content-center
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                ...
                <button type="button" class="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"></button>
                <button type="button" class="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4"></button>
                <button type="button" class="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="4" aria-label="Slide 5"></button>
                <button type="button" class="" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="5" aria-label="Slide 6"></button>
            </div>
            ...
            <div class="w-100 d-flex align-items-center
                ...
                <button class="carousel-control-prev bg-dark rounded-circle" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next bg-dark rounded-circle" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
