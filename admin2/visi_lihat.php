                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql2   = "SELECT * FROM desk_visi";
                                            $q2     = mysqli_query($koneksi, $sql2);
                                            $index  = 1;
                                            while ($r2 = mysqli_fetch_array($q2)) {
                                                $id_desk_visi   = $r2['id_desk_visi'];
                                                $isi_desk_visi   = $r2['isi_desk_visi'];
                                            ?>

                                                <tr>
                                                    <td><?php echo $index++ ?></td>
                                                    <td><?php echo $isi_desk_visi ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql3   = "SELECT * FROM visi";
                                            $q3     = mysqli_query($koneksi, $sql3);
                                            $index2  = 1;
                                            while ($r3 = mysqli_fetch_array($q3)) {
                                                $id_visi   = $r3['id_visi'];
                                                $isi_visi   = $r3['isi_visi'];
                                            ?>

                                                <tr>
                                                    <td><?php echo $index2++ ?></td>
                                                    <td><?php echo $isi_visi ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
