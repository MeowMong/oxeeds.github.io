                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="program_sekolah.php?page=edit_deskripsi&id_deskripsi_program=<?= $row['id_deskripsi_program'] ?>" class="btn btn-warning">Update</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="program_sekolah.php?page=edit&id_program_sekolah=<?= $row['id_program_sekolah'] ?>" class="btn btn-warning mt-1">Update</a>
                                            <a href="program_sekolah.php?delete=<?= $row['id_program_sekolah'] ?>" onclick="return confirm('Ingin menghapus data ?')" class="btn btn-danger mt-1">Hapus</a>
                                        </td>
                                    </tr>
                                <?php
                                }
