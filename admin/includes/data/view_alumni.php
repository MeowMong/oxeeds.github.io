                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="alumni.php?page=edit&id_alumni=<?= $row['id_alumni'] ?>" class="btn btn-warning mt-1">
                                            ...
                                            <a href="alumni.php?delete=<?= $row['id_alumni'] ?>" onclick="return confirm('Ingin menghapus data ?')" class="btn btn-danger mt-1">
